...
void addLast(Node* adder, Node* start, Node* end, int& length, int toAdd)
{
    adder = new Node;
    adder->number = toAdd;
...
void addFirst(Node* adder, Node* start, int& length, int toAdd)
{
    adder = new Node;
    adder->number = toAdd;
...
void deleteLast(Node* start, Node* end, int& length) {
...
void addElem(Node* start, Node* end, int& length, int num) {
    if (num == 0) {
        ...
        int elem;
        cin >> elem;
        addFirst(addNew, start, length, elem);
    }
...
void insertListBegin(Node* start, Node* end, int& length, bool& insert, Node* startBegin, Node* endBegin, int& lengthBegin) {
...
void insertListEnd(Node* start, Node* end, int& length, bool& insert, Node* startBegin, Node* endBegin, int& lengthBegin) {
...
int main()
{
    ...
    do {
        ...
        case 1:
            ...
            cin >> lastElem;
            addLast(add, headBegin, tailBegin, lengthBegin, lastElem);
            break;
        }
    } while (choiceBegin != 0);
    ...
    do
    {
        ...
        cout << "13. Вставить список в спислк по индексу" << endl;
        ...
        case 1:
            ...
            cout << "Введите элемент для добавления: ";
            cin >> lastElem;
            addLast(add, headMain, tailMain, lengthMain, lastElem);
            break;
        case 2:
            int firstElem;
            cout << "Введите элемент для добавления: ";
            cin >> firstElem;
            addFirst(add, headMain, lengthMain, firstElem);
            break;
        case 3:
            deleteLast(headMain, tailMain, lengthMain);
            break;
        ...
        case 14:
            insertListEnd(headMain, tailMain, lengthMain, insert, headBegin, tailBegin, lengthBegin);
            break;

        case 15:
            insertListBegin(headMain, tailMain, lengthMain, insert, headBegin, tailBegin, lengthBegin);
            break;

        case 16:
            if (insert) cout << "Список был вставлен в список" << endl;
